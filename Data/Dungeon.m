...
@synthesize playerStartLocation, liveEnemies, deadEnemies, items, dungeonType;
...
- (id) init 
{
	if (self = [super init])
	{
		...
		self.deadEnemies = [[[NSMutableArray alloc] init] autorelease];
...
- (void) convertToType: (levelType) lvlType 
{
	...
	[Dungeon make: self intoType: lvlType];
...
{
	return [self creatureAtLocation:loc] != nil;
}
...
+ (void) placeItems:(int) number inDungeon:(Dungeon*)dungeon
{
	for (int level=0; level < [dungeon numberOfLevels]; ++level) 
	{
		...
		{
			Coord *itemLoc;
			// Find a square that we can place items in.
...
#define TOWN_WIDTH 12
	const char TOWN [TOWN_WIDTH][TOWN_HEIGHT] =
	{
		...
		{ 'g', 'g', 'g', 'w', 'f', 'f', 'w', 'f', 'f', 'f', 'w', 'g', 'g' } ,
		{ 's', 's', 'g', 'w', 'w', 'w', 'w', 'd', 'w', 'w', 'w', 'g', 'g' } ,
		{ 'g', 's', 'g', 'g', 'g', 'g', 'g', 'g', 'g', 'g', 'g', 'g', 'g' } ,
		{ 'o', 'g', 'g', 'g', 'g', 'g', 'g', 'g', 'g', 'g', 'g', 's', 's' } ,
		{ 'g', 's', 'g', 'g', 'g', 'w', 'w', 'd', 'w', 'w', 'g', 's', 'g' } ,
		{ 's', 's', 'g', 'g', 'g', 'w', 'f', 'f', 'f', 'w', 'g', 'g', 'c' } ,
		{ 'g', 'g', 'g', 'g', 'g', 'w', 'f', 'f', 'f', 'w', 'g', 's', 'g' } ,
		{ 'g', 'g', 'g', 'g', 'g', 'w', 'f', 'f', 'f', 'w', 'g', 's', 's' } ,
		{ 'g', 'g', 'g', 'g', 'g', 'w', 'w', 'w', 'w', 'w', 'g', 'g', 'g' } ,
		{ 'g', 'm', 'g', 'u', 'a', 'g', 'g', 'g', 'g', 'g', 'g', 'g', 'g' }
	};
